...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPassword = (EditText) findViewById(R.id.et_login_pass);
        ...
        findViewById(R.id.tv_link_register).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
    ...
    private void userLogin() {
        ...
        progressBar = (ProgressBar) findViewById(R.id.pbar_login);
